    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "about-section", children: [
        ...
        /* @__PURE__ */ jsxs("ul", { children: [
          ...
          /* @__PURE__ */ jsx("li", { children: "Categories: Work, School, Personal, etc." }),
...
const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Navbar", Navbar, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/calendar-project-group/src/components/navbar.jsx", "client:component-export": "default" })} ${renderComponent($$result, "AboutComponent", About, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/calendar-project-group/src/components/about.jsx", "client:component-export": "default" })}`;
}, "/workspaces/calendar-project-group/src/pages/about.astro", void 0);

const $$file = "/workspaces/calendar-project-group/src/pages/about.astro";
const $$url = "/about";
